...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title> SA car wash | Washing Plans</title>
                    ...
                    <div class="col-md-4">
                        <div class="price-item">
                            <div class="price-header">
                                ...
                                <h2><span>Tk</span><strong>1500</strong><span></span></h2>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="price-item featured-item">
                            <div class="price-header">
                                ...
                                <h2><span>Tk</span><strong>2500</strong><span></span></h2>
                            </div>
                            <div class="price-body">
                                <ul>
                                    <li><i class="far fa-check-circle"></i>Seats Washing</li>
                    ...
                    <div class="col-md-4">
                        <div class="price-item">
                            <div class="price-header">
                                ...
                                <h2><span>Tk</span><strong>3150</strong><span>10% off</span></h2>
                            </div>
                            <div class="price-body">
                                <ul>
                                    <li><i class="far fa-check-circle"></i>Seats Washing</li>
...
<form method="post">   
  <p>
            <select name="packagetype" required class="form-control">
                ...
                <option value="1">BASIC CLEANING (Tk.1500)</option>
                 <option value="2">PREMIUM CLEANING (Tk.2500)</option>
                  <option value="3 ">COMPLEX CLEANING(Tk.3000)</option>
              </select>
